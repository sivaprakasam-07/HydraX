...
//     _checkAndUpdateTemperature(); // ✅ Auto Adjust Temp if Enabled
//     _getCurrentLocation(); // 🌍 Fetch and print current location
//   }
...
//               _currentTemperature = weather.temperature - 5; // 🔥 Cool if hot
//             } else {
//               _currentTemperature = weather.temperature + 5; // ❄️ Warm if cold
//             }
//           });
//           print("✅ Adapted Temp: ${_currentTemperature}°C based on environment");
//         }
//       } else {
